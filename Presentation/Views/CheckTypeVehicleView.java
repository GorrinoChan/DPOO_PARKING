...
public class CheckTypeVehicleView extends JFrame {
    private JButton returnButton, userProfileButton, confirmButton;
    private JLabel titleLabel, typeVehicleLabel, errorLabel, subTitleLabel;
    private JTextField typeVehicleTextField;
    ...
    public CheckTypeVehicleView() {
        ...
        typeVehicleLabel = new JLabel("Tipo del vehiculo");
        gbc.gridx = 1;
        gbc.gridy = 2;
